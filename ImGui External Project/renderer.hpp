...
public:
    ...
    bool create_device_d3d( HWND& m_window ) {
        ...
        return ( m_direct->CreateDevice( D3DADAPTER_DEFAULT , D3DDEVTYPE_HAL , m_window , D3DCREATE_HARDWARE_VERTEXPROCESSING , &m_present , &m_device ) < 0 ? false : true);
    }
    ...
    bool create( bool disable_console = true ) {
        ...
        { 
            ...
            0, 
            0, 
            ( "XO XO XO XO XO LE TS GO OO" ),
            0
        };

        RegisterClassExA( &wc );

        HWND hwnd = CreateWindowExA(0, wc.lpszClassName , ( "XO XO XO XO XO LE TS GO OO" ) , WS_OVERLAPPEDWINDOW , 100 , 100 , 1280 , 800 , NULL , NULL , wc.hInstance , NULL );
